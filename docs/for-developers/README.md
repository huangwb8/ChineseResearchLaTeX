...
| 毕业论文 | `projects/thesis-smu-master`、`projects/thesis-nju-master`、`projects/thesis-smu-postdoc`、`projects/thesis-sysu-doctor`、`projects/thesis-ucas-doctor` | `packages/bensz-thesis/` | `main.pdf` |
