...
> 当前同步源：`huangwb8/ChineseResearchLaTeX@v4.0.0`，发布时间：2026-03-15 17:40（UTC+8）。
...
|------|------|--------|-------------|
| [青年 C](projects/NSFC_Young/) | ✅ 已发布 | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.0/NSFC_Young-v4.0.0.zip)（2.24 MB） | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.0/NSFC_Young-Overleaf-v4.0.0.zip)（13.6 MB） |
| [面上](projects/NSFC_General/) | ✅ 已发布 | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.0/NSFC_General-v4.0.0.zip)（0.96 MB） | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.0/NSFC_General-Overleaf-v4.0.0.zip)（12.4 MB） |
| [地区](projects/NSFC_Local/) | ✅ 已发布 | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.0/NSFC_Local-v4.0.0.zip)（2.26 MB） | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.0/NSFC_Local-Overleaf-v4.0.0.zip)（13.7 MB） |
...
| 模板 | 状态 | 标准包 | Overleaf 包 |
|------|------|--------|-------------|
| [paper-sci-01](projects/paper-sci-01/) | ✅ 已发布 | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.0/paper-sci-01-v4.0.0.zip)（0.37 MB） | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.0/paper-sci-01-Overleaf-v4.0.0.zip)（0.38 MB） |

### 毕业论文模板

> 仓库内已可直接构建；Release 资产后续补齐。

| 模板 | 状态 | 标准包 | Overleaf 包 |
|------|------|--------|-------------|
| [thesis-smu-master](projects/thesis-smu-master/) | ✅ 仓库内可用 | 仓库内构建 | 暂未发布 |
| [thesis-sysu-doctor](projects/thesis-sysu-doctor/) | ✅ 仓库内可用 | 仓库内构建 | 暂未发布 |
| [bensz-thesis](packages/bensz-thesis/) | ✅ 已落地 | 仓库内可用 | 暂未发布 |
<!-- TEMPLATE-LIST:END -->
