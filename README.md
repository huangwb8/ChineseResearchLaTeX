...
AI 负责格式对齐、参考文献管理、章节重构等机械性工作，人类则专注研究设计、学术观点、创新提炼等创造性思维。为适应这一变革，本项目基于 Vibe Coding 理念重构：AI 智能分析模板结构并自动识别需要优化的样式模块，提出优化方案后由人类审核决策，AI 执行并自动编译测试，人类把控最终质量。同时，项目构建了可扩展的 Agent Skills 体系，支持灵活组合与升级，从而在"AI 辅助科研写作"这一任务里充分地压榨 AI 的智能。更重要的是，**斯坦福大学《2025年AI指数报告》显示 LLM 能力正以超越摩尔定律的速度指数级进化**，核心基准测试分数一年内飙升 67.3 个百分点，编码任务通过率从 4.4% 跃升至 71.7%——这意味着本项目的价值将随模型能力增长而持续放大，今天 AI 能帮你完成格式对齐，明天就能协助观点提炼和逻辑重构。**本项目的核心特性**：

- 🤖 **AI 驱动**：智能模板规划、自动样式对齐、代码审查测试
- 🧩 **模块化技能**：可扩展的 AI 技能体系，支持灵活组合与升级
- 👥 **人机协作**：AI 处理机械任务，人类聚焦创意与决策
- 🔬 **科研导向**：专为国自然标书、SCI 论文、毕业论文等科研写作场景深度优化
...
**第三，新增毕业论文写作能力。** 🎓 无数同学在毕业季为格式焦头烂额。现在首批毕业论文公共包与双示例项目已经落地：`packages/bensz-thesis/` + `projects/thesis-smu-master/` + `projects/thesis-sysu-doctor/`。它们先完成了与私有源稿的像素级验收，再被重写为公开可分享的演示内容，后续会继续扩展更多学校与学位类型。
...
> 当前同步源：`huangwb8/ChineseResearchLaTeX@v4.0.1`，发布时间：2026-03-16 06:41（UTC+8）。
...
|------|------|--------|-------------|
| [青年 C](projects/NSFC_Young/) | ✅ 已发布 | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.1/NSFC_Young-v4.0.1.zip)（2.24 MB） | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.1/NSFC_Young-Overleaf-v4.0.1.zip)（13.6 MB） |
| [面上](projects/NSFC_General/) | ✅ 已发布 | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.1/NSFC_General-v4.0.1.zip)（0.96 MB） | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.1/NSFC_General-Overleaf-v4.0.1.zip)（12.4 MB） |
| [地区](projects/NSFC_Local/) | ✅ 已发布 | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.1/NSFC_Local-v4.0.1.zip)（2.26 MB） | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.1/NSFC_Local-Overleaf-v4.0.1.zip)（13.7 MB） |
...
| 模板 | 状态 | 标准包 | Overleaf 包 |
|------|------|--------|-------------|
| [paper-sci-01](projects/paper-sci-01/) | ✅ 已发布 | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.1/paper-sci-01-v4.0.1.zip)（0.37 MB） | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.1/paper-sci-01-Overleaf-v4.0.1.zip)（0.38 MB） |
...
| 模板 | 状态 | 标准包 | Overleaf 包 |
|------|------|--------|-------------|
| [thesis-smu-master](projects/thesis-smu-master/) | ✅ 已发布 | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.1/thesis-smu-master-v4.0.1.zip)（0.54 MB） | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.1/thesis-smu-master-Overleaf-v4.0.1.zip)（0.55 MB） |
| [thesis-sysu-doctor](projects/thesis-sysu-doctor/) | ✅ 已发布 | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.1/thesis-sysu-doctor-v4.0.1.zip)（0.54 MB） | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.1/thesis-sysu-doctor-Overleaf-v4.0.1.zip)（0.55 MB） |
<!-- TEMPLATE-LIST:END -->
...
AI 会自动联网访问项目文档了解安装方式并完成安装。小白专用！
...
适用于 `projects/NSFC_General`、`projects/NSFC_Local`、`projects/NSFC_Young`：
...
适用于 `projects/paper-sci-01`，支持 PDF + DOCX 双输出：
...
适用于 `projects/thesis-smu-master`、`projects/thesis-sysu-doctor`：
