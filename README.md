...
> 当前同步源：`huangwb8/ChineseResearchLaTeX@v4.0.2`，发布时间：2026-03-16 15:31（UTC+8）。
...
|------|------|--------|-------------|
| [青年 C](projects/NSFC_Young/) | ✅ 已发布 | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.2/NSFC_Young-v4.0.2.zip)（2.24 MB） | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.2/NSFC_Young-Overleaf-v4.0.2.zip)（13.6 MB） |
| [面上](projects/NSFC_General/) | ✅ 已发布 | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.2/NSFC_General-v4.0.2.zip)（0.96 MB） | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.2/NSFC_General-Overleaf-v4.0.2.zip)（12.4 MB） |
| [地区](projects/NSFC_Local/) | ✅ 已发布 | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.2/NSFC_Local-v4.0.2.zip)（2.26 MB） | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.2/NSFC_Local-Overleaf-v4.0.2.zip)（13.7 MB） |
...
| 模板 | 状态 | 标准包 | Overleaf 包 |
|------|------|--------|-------------|
| [paper-sci-01](projects/paper-sci-01/) | ✅ 已发布 | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.2/paper-sci-01-v4.0.2.zip)（0.37 MB） | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.2/paper-sci-01-Overleaf-v4.0.2.zip)（0.38 MB） |
...
| 模板 | 状态 | 标准包 | Overleaf 包 |
|------|------|--------|-------------|
| [thesis-smu-master](projects/thesis-smu-master/) | ✅ 已发布 | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.2/thesis-smu-master-v4.0.2.zip)（0.54 MB） | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.2/thesis-smu-master-Overleaf-v4.0.2.zip)（0.55 MB） |
| [thesis-sysu-doctor](projects/thesis-sysu-doctor/) | ✅ 已发布 | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.2/thesis-sysu-doctor-v4.0.2.zip)（0.54 MB） | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.2/thesis-sysu-doctor-Overleaf-v4.0.2.zip)（0.56 MB） |
...
| 模板 | 状态 | 标准包 | Overleaf 包 |
|------|------|--------|-------------|
| [cv-01](projects/cv-01/) | ✅ 已发布 | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.2/cv-01-v4.0.2.zip)（1.99 MB） | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.2/cv-01-Overleaf-v4.0.2.zip)（101.1 MB） |
<!-- TEMPLATE-LIST:END -->
...
- `projects/` 下每个示例项目都自带与目录同名的 `*.code-workspace` 和 `.vscode/settings.json`；本地开发时，建议直接用该工作区文件打开项目，让 LaTeX Workshop 自动走项目内置的 Python 构建 wrapper
...
curl -fsSL https://raw.githubusercontent.com/huangwb8/ChineseResearchLaTeX/main/scripts/install.py \
  | python3 - install --packages bensz-nsfc
...
```bash
# 安装 bensz-nsfc（默认）
python3 scripts/install.py install --packages bensz-nsfc
