...
> 当前同步源：`huangwb8/ChineseResearchLaTeX@v4.0.6`，发布时间：2026-03-16 21:51（UTC+8）。
...
|------|------|--------|-------------|
| [青年 C](projects/NSFC_Young/) | ✅ 已发布 | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.6/NSFC_Young-v4.0.6.zip)（2.24 MB） | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.6/NSFC_Young-Overleaf-v4.0.6.zip)（9.19 MB） |
| [面上](projects/NSFC_General/) | ✅ 已发布 | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.6/NSFC_General-v4.0.6.zip)（0.96 MB） | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.6/NSFC_General-Overleaf-v4.0.6.zip)（7.91 MB） |
| [地区](projects/NSFC_Local/) | ✅ 已发布 | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.6/NSFC_Local-v4.0.6.zip)（2.26 MB） | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.6/NSFC_Local-Overleaf-v4.0.6.zip)（9.21 MB） |
...
> 如果最关键的是 `reference.docx`、目标 Word 模板或 PDF / DOCX 对齐问题，请优先提交 [DOCX 模板问题/需求](https://github.com/huangwb8/ChineseResearchLaTeX/issues/new?template=docx-template-support.yml)。

| 模板 | 状态 | 标准包 | Overleaf 包 |
|------|------|--------|-------------|
| [paper-sci-01](projects/paper-sci-01/) | ✅ 已发布 | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.6/paper-sci-01-v4.0.6.zip)（0.37 MB） | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.6/paper-sci-01-Overleaf-v4.0.6.zip)（0.38 MB） |
...
|------|------|------|--------|-------------|
| [thesis-smu-master](projects/thesis-smu-master/) | 南方医科大学 | 硕士 | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.6/thesis-smu-master-v4.0.6.zip)（0.54 MB） | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.6/thesis-smu-master-Overleaf-v4.0.6.zip)（0.55 MB） |
| [thesis-sysu-doctor](projects/thesis-sysu-doctor/) | 中山大学 | 博士 | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.6/thesis-sysu-doctor-v4.0.6.zip)（0.55 MB） | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.6/thesis-sysu-doctor-Overleaf-v4.0.6.zip)（1.01 MB） |
...
| 模板 | 状态 | 标准包 | Overleaf 包 |
|------|------|--------|-------------|
| [cv-01](projects/cv-01/) | ✅ 已发布 | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.6/cv-01-v4.0.6.zip)（1.99 MB） | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.6/cv-01-Overleaf-v4.0.6.zip)（40.0 MB） |
<!-- TEMPLATE-LIST:END -->
