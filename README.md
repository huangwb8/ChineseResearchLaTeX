...
| [nsfc-roadmap](skills/nsfc-roadmap/) | v0.11.0 | 📝 日常 | NSFC 技术路线图生成（.drawio → .svg/.png/.pdf） | 🚧 开发中 |
| [nsfc-schematic](skills/nsfc-schematic/) | v0.13.1 | 📝 日常 | NSFC 原理图/机制图生成（.drawio → .svg/.png/.pdf） | 🚧 开发中 |
