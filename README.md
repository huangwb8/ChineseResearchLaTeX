...
在 **Claude Code** 或 **OpenAI Codex** 中输入以下 Prompt，AI 会自动联网访问项目文档了解安装方式并完成安装：

```
请参考 https://github.com/huangwb8/ChineseResearchLaTeX 项目，
帮我安装 bensz-nsfc LaTeX 公共包（最新稳定版）。
```
