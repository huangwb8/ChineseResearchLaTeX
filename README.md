...
> 当前同步源：`huangwb8/ChineseResearchLaTeX@v4.0.9`，发布时间：2026-03-25 07:37（UTC+8）。
...
|------|------|--------|-------------|
| [青年 C](projects/NSFC_Young/) | ✅ 已发布 | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.9/NSFC_Young-v4.0.9.zip)（2.24 MB） | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.9/NSFC_Young-Overleaf-v4.0.9.zip)（9.19 MB） |
| [面上](projects/NSFC_General/) | ✅ 已发布 | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.9/NSFC_General-v4.0.9.zip)（0.96 MB） | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.9/NSFC_General-Overleaf-v4.0.9.zip)（7.91 MB） |
| [地区](projects/NSFC_Local/) | ✅ 已发布 | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.9/NSFC_Local-v4.0.9.zip)（2.26 MB） | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.9/NSFC_Local-Overleaf-v4.0.9.zip)（9.21 MB） |
...
| 模板 | 状态 | 标准包 | Overleaf 包 |
|------|------|--------|-------------|
| [paper-sci-01](projects/paper-sci-01/) | ✅ 已发布 | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.9/paper-sci-01-v4.0.9.zip)（0.37 MB） | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.9/paper-sci-01-Overleaf-v4.0.9.zip)（0.37 MB） |

### 毕业论文模板

> 公共包 + 示例项目已落地，支持 PDF 输出与像素级验收。
> 毕业论文模板通常需要按学校、学院或学位规范做个性化定制；如有这类需求，建议提交 [毕业论文模板定制需求](https://github.com/huangwb8/ChineseResearchLaTeX/issues/new?template=thesis-template-customization.yml)。

| 模板 | 院校 | 学位 | 标准包 | Overleaf 包 |
|------|------|------|--------|-------------|
| [thesis-smu-master](projects/thesis-smu-master/) | 南方医科大学 | 硕士 | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.9/thesis-smu-master-v4.0.9.zip)（0.54 MB） | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.9/thesis-smu-master-Overleaf-v4.0.9.zip)（0.56 MB） |
| [thesis-sysu-doctor](projects/thesis-sysu-doctor/) | 中山大学 | 博士 | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.9/thesis-sysu-doctor-v4.0.9.zip)（0.55 MB） | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.9/thesis-sysu-doctor-Overleaf-v4.0.9.zip)（1.02 MB） |
| [thesis-ucas-doctor](projects/thesis-ucas-doctor/) | 中国科学院大学 | 博士 | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.9/thesis-ucas-doctor-v4.0.9.zip)（0.41 MB） | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.9/thesis-ucas-doctor-Overleaf-v4.0.9.zip)（0.88 MB） |
...
| 模板 | 状态 | 标准包 | Overleaf 包 |
|------|------|--------|-------------|
| [cv-01](projects/cv-01/) | ✅ 已发布 | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.9/cv-01-v4.0.9.zip)（1.99 MB） | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.9/cv-01-Overleaf-v4.0.9.zip)（40.0 MB） |
<!-- TEMPLATE-LIST:END -->
...
仓库已支持在 **GitHub 默认分支有新 commit 时自动把最新提交同步到 Gitee**。对应流程文件为 [sync-gitee-mirror.yml](/Volumes/2T01/Github/ChineseResearchLaTeX/.github/workflows/sync-gitee-mirror.yml)，它会在 `push` 到 `main` 时立即同步，并额外每小时巡检一次；同步脚本会在推送后校验 Gitee 远端分支是否已经对齐到同一 commit，避免“看起来成功、实际上没推到位”。
...
配好后，默认分支每次有新 commit 都会自动同步；如需手动补推某个 tag，也可通过 `workflow_dispatch` 显式传 `tag`。完整配置与排障步骤见 [docs/gitee-sync-guide.md](/Volumes/2T01/Github/ChineseResearchLaTeX/docs/gitee-sync-guide.md)。
