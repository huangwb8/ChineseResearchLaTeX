...
v4版本暂时是内测版本。 2026年申请标书的小伙伴请用v3版本。 具体看release历史。 
...
如果你想先理解 `bensz-nsfc` 为什么采用当前“公共包 + 薄项目”结构，可先阅读 [docs/bensz-nsfc-design-principles.md](docs/bensz-nsfc-design-principles.md)；如果你更关心如何直接开始写标书，再看 [docs/nsfc-usage-guide.md](docs/nsfc-usage-guide.md)。
