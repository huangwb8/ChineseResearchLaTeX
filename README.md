...
**我的目标是在 2027 年 2 月前发布稳定版本** 🎯，全面支持三条写作主线，并将 Vibe Writing 贯穿始终——不再只是"提供模板"，而是让 AI 真正参与你的写作过程。
...
**第二，持续扩展期刊论文写作能力。** 📄 科研不只是申基金，更多时候是写论文。仓库中首个面向 SCI 期刊的公共包与示例项目已经落地：`packages/bensz-paper/` + `projects/paper-sci-01/`。接下来我会继续扩展更多论文风格与工作流，但现在已经可以用这条链路完成 PDF + DOCX 双输出的论文模板写作。

**第三，新增毕业论文写作能力。** 🎓 无数同学在毕业季为格式焦头烂额。我将整合高校毕业论文 LaTeX 模板（硕士、博士），配套 Vibe Writing 辅助，让毕业生把精力放在内容上，而不是与样式文件死磕。

三条主线，一个截止日期，一套方法论：**2027 年 2 月，ChineseResearchLaTeX 将成为真正覆盖中国科研全链条的 LaTeX + Vibe Writing 平台** 🚀——国自然、期刊论文、毕业论文，一个项目全搞定。
...
> ⚠️ **建议优先使用最新正式 [Release](https://github.com/huangwb8/ChineseResearchLaTeX/releases/tag/v4.0.0)。** 该列表由 GitHub Actions 每小时自动检查一次，也支持手动触发同步。
> 当前同步源：[`huangwb8/ChineseResearchLaTeX@v4.0.0`](https://github.com/huangwb8/ChineseResearchLaTeX/releases/tag/v4.0.0)，发布时间：2026-03-15 17:40（UTC+8）。
...
|------|------|--------|-------------|------------|------|
| [青年 C](projects/NSFC_Young/) | ✅ 已发布 | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.0/NSFC_Young-v4.0.0.zip)（2.24 MB） | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.0/NSFC_Young-Overleaf-v4.0.0.zip)（13.6 MB） | [v4.0.0](https://github.com/huangwb8/ChineseResearchLaTeX/releases/tag/v4.0.0)<br>2026-03-15 17:40（UTC+8） | 2026 青年科学基金项目正文模板 |
| [面上](projects/NSFC_General/) | ✅ 已发布 | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.0/NSFC_General-v4.0.0.zip)（0.96 MB） | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.0/NSFC_General-Overleaf-v4.0.0.zip)（12.4 MB） | [v4.0.0](https://github.com/huangwb8/ChineseResearchLaTeX/releases/tag/v4.0.0)<br>2026-03-15 17:40（UTC+8） | 2026 面上项目正文模板 |
| [地区](projects/NSFC_Local/) | ✅ 已发布 | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.0/NSFC_Local-v4.0.0.zip)（2.26 MB） | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.0/NSFC_Local-Overleaf-v4.0.0.zip)（13.7 MB） | [v4.0.0](https://github.com/huangwb8/ChineseResearchLaTeX/releases/tag/v4.0.0)<br>2026-03-15 17:40（UTC+8） | 2026 地区科学基金项目正文模板 |
...
| 模板 | 状态 | 标准包 | Overleaf 包 | 最新稳定版 | 说明 |
|------|------|--------|-------------|------------|------|
| [paper-sci-01](projects/paper-sci-01/) | ✅ 已发布 | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.0/paper-sci-01-v4.0.0.zip)（0.37 MB） | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.0/paper-sci-01-Overleaf-v4.0.0.zip)（0.38 MB） | [v4.0.0](https://github.com/huangwb8/ChineseResearchLaTeX/releases/tag/v4.0.0)<br>2026-03-15 17:40（UTC+8） | 首个公开 SCI 示例项目 |

### 毕业论文模板

> 当前仍处于包级预留阶段，后续有公开示例时会自动接入最新 Release 资产。

| 模板 | 状态 | 标准包 | Overleaf 包 | 最新稳定版 | 说明 |
|------|------|--------|-------------|------------|------|
| [bensz-thesis](packages/bensz-thesis/) | 🚧 预留位点 | 暂未发布 | 暂未发布 | 待发布 | 当前仅保留包级扩展位点，尚无公开示例与 Release 资产。 |
<!-- TEMPLATE-LIST:END -->
...
- [国自然模板使用说明](docs/nsfc-usage-guide.md)
- [NSFC 模板迁移说明](docs/migration-guide.md)
- [LaTeX 写作指南](docs/latex-writing-guide.md)
- [bensz-paper 包说明](packages/bensz-paper/README.md)
- [paper-sci-01 项目说明](projects/paper-sci-01/README.md)

---

## NSFC 公共包安装

与 NSFC 公共包直接相关的安装、构建、校验脚本，现已统一收敛到 `packages/bensz-nsfc/scripts/`。
这些脚本作为 `bensz-nsfc` 包的一部分安装；打包具体项目 zip 时，不再重复附带整份 `packages/bensz-nsfc/scripts/`。

自本次重构起，`NSFC_General`、`NSFC_Local`、`NSFC_Young` 的 `@config.tex` 已统一改为加载公共包 `bensz-nsfc-common`。首次使用前，请先执行官方安装入口：

```bash
python packages/bensz-nsfc/scripts/install.py install --ref v3.5.1
```

如果你正在当前仓库里开发/调试模板，推荐直接安装本地工作树版本：
...
- `python packages/bensz-nsfc/scripts/install.py pin --ref v3.5.1`：在当前项目写入 `.nsfc-version`
- `python packages/bensz-nsfc/scripts/install.py sync`：按项目锁文件切换版本
- `python packages/bensz-nsfc/scripts/install.py check`：检查当前激活版本与项目锁定版本是否一致
...
- 公共包：`packages/bensz-paper/`
- 示例项目：`projects/paper-sci-01/`
- 官方构建入口：`python packages/bensz-paper/scripts/paper_project_tool.py build --project-dir projects/paper-sci-01`

这条链路会：

- 从 `artifacts/source/*.md` 自动生成 LaTeX 片段
- 统一输出 `main.pdf` 与 `main.docx`
- 将中间文件隔离到 `.latex-cache/`
- 保持示例正文公开可分享，不混入未发表论文内容
