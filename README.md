...
| 工具 | 推荐模型 | 适用场景 |
|------|----------|----------|
| **Codex CLI** | GPT-5.2 High | 执行计划、复杂任务、长上下文、高质量输出（速度较慢） |
| **Claude Code** | Claude 4.5 Opus | 执行计划、复杂任务、高质量输出（比较昂贵） |
...
- **systematic-literature-review**：系统综述（AI 自定检索词，多源检索→去重→AI 逐篇阅读并评分，生成专家级综述；表格样式与导出链路更稳健）
...
| [systematic-literature-review](skills/systematic-literature-review/) | v1.0.5 | 📝 日常 | 令人印象深刻的精准、全面的专家级综述 | ✅ 稳定 |
