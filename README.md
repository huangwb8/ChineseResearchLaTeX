...
为 Vibe Writing 辅助 2026 年国自然申请做好准备！💡 创作不易，如果这个项目对您有帮助，请给个 ⭐ Star 持续关注！
...
#### ✍️ 标书写作阶段
- **nsfc-abstract**：中英文摘要生成（中文≤400字含标点；英文≤4000字符含标点；英文为中文的忠实翻译，不新增信息；输出写入工作目录 `NSFC-ABSTRACTS.md`）
...
| [nsfc-abstract](skills/nsfc-abstract/) | v0.1.1 | 📝 日常 | NSFC 中英文摘要生成（中文≤400字；英文≤4000字符） | 🚧 开发中 |
