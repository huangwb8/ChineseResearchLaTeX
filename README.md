...
> 当前同步源：`huangwb8/ChineseResearchLaTeX@v4.0.18`，发布时间：2026-06-11 10:43（UTC+8）。
...
> ⚠️ **提交时间窗口**：毕业论文模板定制需求仅在每年 **4–10 月** 接受处理；11 月至次年 3 月提交的 Issue 将在次年 4 月后统一处理，除非另有约定。
...
| 工具 | 推荐模型 | 适用场景 |
|------|----------|----------|
| **Codex CLI** | GPT-5.5 High/xHigh | 执行计划、复杂任务、长上下文、高质量输出、指令遵循好、速度较慢但相对便宜 |
| **Codex CLI** | GPT-5.5 Medium | 轻至中量调整、格式修复；指令遵循不错、全局把控力尚可 |
| **Codex CLI**  | GPT-5.5 Medium | 规划计划、轻至中量调整、格式修复 |
| **Codex CLI**  | GPT-5.5 Medium | Git-commit、简单任务 |
