...
\newcommand{\BudgetCJKFakeBold}{1.8}
...
% 标题与正文中的“中文加粗字体”族。
% 这里统一复用 \BudgetCJKFakeBold，用户通常不需要改下面两段，只改参数即可。
...
\IfFileExists{./fonts/FandolHei-Regular.otf}{
  \newCJKfontfamily\budgetboldfont{FandolHei-Regular}[Path=./fonts/,Extension=.otf,AutoFakeBold=\BudgetCJKFakeBold]
}{
  \newCJKfontfamily\budgetboldfont{Heiti SC}[AutoFakeBold=\BudgetCJKFakeBold]
}
