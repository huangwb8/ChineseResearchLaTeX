...
def rollback_from_backup(
    *,
    ...
    backup_path = find_backup_for_run(runs_root=runs_root, run_id=run_id, filename=target_path.name)
    ...
    if backup_current and target_path.exists():
        ...
        backup_file(src=target_path, backup_root=backup_root, run_id=rid)
