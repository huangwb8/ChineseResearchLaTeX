...
- `SKILL.md` 新增二分转折句分类处理规则：区分真实边界、伪对立和同义递进，分别采用弱化边界、拆掉对称骨架或合并重复概念的改写策略。
- `references/machine-patterns.md` 补充“不是……而是……”句式的判断要点、可用处理和禁止新增事实提醒。
...
- `SKILL.md` 与 `references/machine-patterns.md` 明确“研究动作优先”的改写策略，并强调不得把具体化误写成新增事实。
- `config.yaml` / `README.md`：版本号更新至 1.1.0（单一真相来源），README 补充抽象定位过重场景的推荐用法。
