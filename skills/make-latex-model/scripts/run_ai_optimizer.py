...
示例：
  python3 skills/make-latex-model/scripts/run_ai_optimizer.py --project NSFC_Local --iteration 1 --mode heuristic
  python3 skills/make-latex-model/scripts/run_ai_optimizer.py --project NSFC_Local --iteration 1 --mode manual_file
"""
