...
\geometry{left=3.175cm,right=3.175cm,top=2.54cm,bottom=2.54cm} % 页边距（2026 Word 预览：左右各约 90pt=1.25in）
...
%%%————————————————————————————————字号
% 2026 对齐：Word 模板（QuickLook Preview）显示正文为 120% 行距，故这里显式使用 1.2x baselineskip。
\newcommand{\chuhao}{\fontsize{42pt}{50.4pt}\selectfont}
\newcommand{\xiaochuhao}{\fontsize{36pt}{43.2pt}\selectfont}
\newcommand{\yihao}{\fontsize{26pt}{31.2pt}\selectfont}
\newcommand{\erhao}{\fontsize{22pt}{26.4pt}\selectfont}
\newcommand{\xiaoerhao}{\fontsize{18pt}{21.6pt}\selectfont}
...
\newcommand{\yemeizihao}{\fontsize{11pt}{13.2pt}\selectfont}
\newcommand{\wuhao}{\fontsize{10.5pt}{12.6pt}\selectfont}
\newcommand{\xiaowuhao}{\fontsize{9pt}{10.8pt}\selectfont}
\newcommand{\liuhao}{\fontsize{7.875pt}{9.45pt}\selectfont}
\newcommand{\qihao}{\fontsize{5.25pt}{6.3pt}\selectfont}
%字号对照表
%二号 21pt
%四号 14
%小四 12
...
% Define section font
\newcommand{\sectionzihao}{\fontsize{14pt}{16.8pt}\selectfont}
\newcommand{\subsectionzihao}{\fontsize{14pt}{16.8pt}\selectfont}
\newcommand{\subsubsectionzihao}{\fontsize{13.5pt}{16.2pt}\selectfont}


% Custom format for section
\titleformat{\section}
  {\color{MsBlue} \sectionzihao \templatefont \bfseries} % format（2026：Word 预览为加粗）
  {\hspace{2.5em}} % label（2026：约 21pt 左缩进 + 14pt 首行缩进）
  {0pt} % separation
  {}   % before-code
