...
根据 plans/重构-v202603101512.md 重构本项目。 我已经做好github备份，你放心大胆地做。使用 awesome-code skill 辅助规划、优化。所有问题都要解决，所有建议都要落实。 如果工作时有疑问，或者有更好的方案，自己选个最优方案优化，不要问我。不要破坏其它功能。要保证最终成品能正常、稳定、高效地工作。目前的最主要目标： 当项目重构完后，NSFC_General、NSFC_Local、NSFC_Young渲染出来的PDF和之前完全一样。
