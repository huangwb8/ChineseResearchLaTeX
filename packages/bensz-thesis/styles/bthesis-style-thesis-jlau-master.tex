\ProvidesFile{bthesis-style-thesis-jlau-master.tex}
  [2026/06/05 v1.0.2 Thesis style: thesis-jlau-master]
...
\newcommand{\jlauCoverEmblemAt}[1]{%
  \begin{scope}[shift={(#1)}]
    ...
    \node[inner sep=0pt] at (0,0)
      {\includegraphics[width=3.08cm,height=3.08cm]{\jlauEmblemPath}};
  \end{scope}%
}
...
\newcommand{\jlauMakeCover}{%
  ...
  \begin{tikzpicture}[remember picture,overlay]
    ...
    \jlauCoverEmblemAt{[yshift=-5.55cm]current page.north}
