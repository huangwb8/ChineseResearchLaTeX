...
本项目刻意不新建 \texttt{bensz-postdoc} 一类公共包，原因有二。第一，当前真正稳定、已被多套项目验证的仍是 \texttt{bensz-thesis} 的构建链路和页面样式能力；第二，博士后研究报告的差异主要集中在项目前置页和结尾页，而不是共享底层宏包本身。把差异先控制在项目层，能更好地避免对现有 thesis 模板造成连带风险。
