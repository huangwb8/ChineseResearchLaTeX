...
\geometry{left=3.20cm,right=3.20cm,top=2.67cm,bottom=3.16cm} % 页边距 (对齐 Word 2026 PDF: 左3.2 右3.2 上2.67 下3.16)
...
\titlespacing*{\section}
  ...
  {7.8pt} % Space after the title（对齐 Word 段后 0.27cm ≈ 7.8pt）
