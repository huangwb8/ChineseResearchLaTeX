# NSFC 青年科学基金项目申请书 - AI 写作指令

本目录是 **国家自然科学基金青年科学基金项目（C类）**申请书的 LaTeX 工作区。AI 在此的核心任务是**辅助撰写和优化标书内容**，不做版式开发，不改动 `extraTex/@config.tex`（除非用户明确要求调整版式）。
...
| `extraTex/3.3.承担项目情况.tex` | （三）承担项目 | 申请人正在承担的相关项目 |
...
> **与面上项目的主要差异**：青年项目第（三）部分承担项目情况仅限**申请人**（不含主要参与者），且整体篇幅期望更简洁。
