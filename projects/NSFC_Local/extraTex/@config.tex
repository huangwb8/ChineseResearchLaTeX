...
% 当前默认值：left=3.20cm,right=2.94cm,top=2.67cm,bottom=2.91cm
\newcommand{\NSFCProjectGeometryOptions}{left=3.20cm,right=2.94cm,top=2.67cm,bottom=2.91cm}
...
% 当前默认值：true
\newcommand{\NSFCProjectRaggedBottom}{true}
...
% 当前默认值：地区项目 profile 的真实默认值。
\newcommand{\NSFCProjectSectionBefore}{2pt plus 0pt minus 0pt}
\newcommand{\NSFCProjectSectionAfter}{2pt}
\newcommand{\NSFCProjectSubsectionIndent}{2pt}
\newcommand{\NSFCProjectSubsectionBefore}{5pt plus 0pt minus 0pt}
\newcommand{\NSFCProjectSubsectionAfter}{5pt}
\newcommand{\NSFCProjectSubsubsectionBefore}{5pt plus 0pt minus 0pt}
