...
\else
  \setCJKfamilyfont{sectionzhfont}[Path=./fonts/, Extension=.ttf, AutoFakeBold=5]{Kaiti} % 定义模板中文字体为楷体
  \newcommand{\sectionzhfont}{\CJKfamily{sectionzhfont}} % 定义模板中文字体为新命令\sectionzhfont
  \newfontfamily\sectionenfont[Path=./fonts/, Extension=.ttf, AutoFakeBold=5]{Kaiti} % 定义模板中英文字体为楷体，并定义新命令\sectionzhfont
  \NewDocumentCommand \templatefont {} {\sectionzhfont \sectionenfont} % 模板中英文字体
  % \setmainfont[Path=./fonts/, Extension=.ttf]{TimesNewRoman} % 定义主体内容的英文字体为Times New Roman。由于是外挂字体，无法自由使用英文斜体和粗体。
  % \setCJKmainfont[Path=./fonts/, Extension=.ttf, AutoFakeBold=5]{SimSun} % 定义主体内容的字体为SimSun
  \setCJKmainfont[Path=./fonts/, Extension=.ttf, AutoFakeBold=5]{Kaiti} % 定义主体内容的字体为Kaiti
  \setCJKmonofont[Path=./fonts/, Extension=.ttf, AutoFakeBold=5]{Kaiti} % 定义 CJK 等宽字体（避免 xeCJK tt 字体警告）
