...
\begin{figure}[htbp]
  \centering
  \subfigure[多模态数据整合技术路线]{%
    \includegraphics[width=0.48\textwidth]{figures/zzmx-115.jpg}%
    \label{fig:data-pipeline}%
  }
  \subfigure[跨文化比较研究分析框架]{%
    \includegraphics[width=0.48\textwidth]{figures/zzmx-mobile-105.jpg}%
    \label{fig:comparison-framework}%
  }
  \caption{关键技术路线与比较研究框架示意图（projects/NSFC\_Local/figures/）。}
\end{figure}
