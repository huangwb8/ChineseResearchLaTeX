...
\else
  % 优先使用系统字体（用于对齐 macOS/LibreOffice 导出的 2026 Word 模板 PDF），不存在则回退到仓库内置字体
  \IfFontExistsTF{SIL-Kai-Reg-Jian}{
    \setCJKfamilyfont{sectionzhfont}{SIL-Kai-Reg-Jian}[AutoFakeBold=3]
    \newcommand{\sectionzhfont}{\CJKfamily{sectionzhfont}}
    \newfontfamily\sectionenfont{SIL-Kai-Reg-Jian}[AutoFakeBold=3]
    \NewDocumentCommand \templatefont {} {\sectionzhfont \sectionenfont}
    \setCJKmainfont{SIL-Kai-Reg-Jian}[AutoFakeBold=3]
  }{
...
% Define section font
\newcommand{\sectionzihao}{\fontsize{14pt}{14pt}\selectfont}
